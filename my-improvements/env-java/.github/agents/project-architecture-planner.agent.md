...
model: GPT-5
tools: ['search/codebase', 'search', 'web/fetch', 'edit/editFiles', 'vscode/getProjectSetupInfo', 'vscode/installExtension', 'vscode/newWorkspace', 'vscode/runCommand', 'vscode.mermaid-chat-features/renderMermaidDiagram', 'openSimpleBrowser', 'execute/getTerminalOutput', 'execute/runInTerminal', 'read/terminalLastCommand', 'read/terminalSelection', 'read/problems', 'search/usages', 'todo']
---
